...
public:
	...
	status_t begin( void );
	status_t begin( uint8_t pin1 , uint8_t pin2 , intFuncPtr intHandle1 , intFuncPtr intHandle2 );
	void setMode( workMode_t mode );
	
	eventType_t getEventType( uint32_t  timeOut );
